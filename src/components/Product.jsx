    ...
    <div className="flex flex-col items-center justify-between border
      ...
      <div className="flex justify-between gap-12 ">
        ...
        
        {
          cart.some((p) => p.id === post.id)?
          (<button 
            className="text-red-500 border-2 border-gray-700 rounded-full font-semibold 
             text-[12px] p-1 px-3 uppercase 
            hover:bg-red-500
            hover:text-white transition duration-300 ease-in"
          onClick={removeFromCart}>
          ...
          (
            <button
            className="text-green-500 border-2 border-gray-700 rounded-full font-semibold 
             text-[12px] p-1 px-3 uppercase 
            hover:bg-green-500
            hover:text-white transition duration-300 ease-in"
            onClick={addToCart}>
